...
Given an original URL "https://example.com/products/cloud-platform", this application will generate a 6-character shortCode like "8mK2xQ" and generate a short URL like "https://api-domain/8mK2xQ". 
